...
python clarify_aware_fine_tuning_v2.py --dataset_path /project/def-fard/jie/finetuning_data/split_20_80_downsample.json --model_name_or_path /project/def-fard/jie/deepseek-ai/deepseek-coder-6.7b-instruct  --output_dir output-dir --tokenize_version 4 --finetuned_model_path /project/def-fard/jie/finetuned_models/deepseek-coder-6.7b-instruct-finetuned-02252025-split_20_80_downsample > result_02252025_split_20_80_downsample.txt